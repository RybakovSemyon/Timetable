...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE Lessons ( _id INTEGER PRIMARY KEY AUTOINCREMENT, Subject TEXT, TimeStart TEXT, TimeEnd TEXT, Type TEXT, Parity TEXT, DateStart TEXT, DateEnd TEXT, Dates TEXT, ClusterId TEXT, ClusterName TEXT, ClusterType TEXT, DDay INTEGER, FOREIGN KEY (DDay) REFERENCES Days(_id));");
